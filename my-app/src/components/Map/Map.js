    ...
    getCovidAPI() {
        ...
        fetch(url)
            ...
            .then(contents => {
                ...
                //   console.this.setState({states: v});
            });
    }

    showPopup(st) {
        this.setState({ popup_active:st });
        this.setState({ popup_data: { part1: this.getAPIData(st), part2: this.getCovidAPI(st) } });
    }

    renderPopup() {
        return <Popup data={ this.state.popup_data } />
    }
